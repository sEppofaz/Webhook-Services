...
- **Überholt (2026-08-30):** Der frühere Dauer-Rot-Alarm `pyee 13 → 14` bei `rename-webhook` existiert nicht mehr – `pyee` steht auf 14.0.0, nur `pip check` meldet weiter `playwright 1.62.0 requires pyee<14,>=13` (funktional unkritisch).
